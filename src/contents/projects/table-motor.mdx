...
EDIT (Jan 18, 2025):
I have added a button to my setup to ensure that I can still use this table motor when the internet is down, meaning it won't get locked shut. The updated code is located in the [project on github](https://github.com/emackinnon1/pico-table-motor/tree/main).
