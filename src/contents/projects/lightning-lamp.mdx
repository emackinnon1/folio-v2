...
that controls the LED "lightning" noodles if you're implementing that feature. I 
controlled two LED noodles with one dual output mosfet, but I would go back and 
control the two noodles separately, giving a bit more dynamism. This function is 
where you can add more output pins for doing so. 
