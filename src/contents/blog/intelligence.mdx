...
between the two generating evaluations and calculations and the anterior
cingulate cortex playing a role in inhibiting or promoting responses. There is a
general consensus that the PFIT is seen as the "best available answer" to the
question of "where" in the brain intelligence resides, with a hint of "how".
