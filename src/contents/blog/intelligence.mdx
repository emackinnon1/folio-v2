...
learning new skills, it may be moderately improved in some areas. Less activity
(in some regions and under some circumstances) correlates to higher IQs in many
cases (again, with some nuance), suggesting that efficient networks play a part
in intelligence. All of these metrics are very predictive of certain outcomes
