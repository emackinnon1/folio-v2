...
outcomes across populations. I won't get deep into the nitty gritty of political
views, but I will examine some of the usual broad solutions and policy thrusts
...
None of this is to say that environment is irrelevant. The same studies that
point to genes' influence also point to environment playing a role, but the role
is very nuanced. Nutrition, stable learning environments, and socioeconomic
status all influence cognitive development. Early on, differences in environment
account for a high percentage (around 75% at age 5!) of differences of
intelligence, but this drops to less 20 percent by age 18. Environment plays a
part, but it does not play a part as strongly as we once believed. Early
intervention in childhood to improve outcomes, like public policy that invests
heavily in childhood schooling to improve test scores, has had very limited
effects over the long term so far. With more understanding of gene expression in
relation to intelligence, this could change.
