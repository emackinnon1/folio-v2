...
development programs offer far more than just intelligence gains. They benefit
participants by providing opportunities for socialization, athletics, nutrition
(in some cases, very, _very_ sadly, the best a child will get all week), novel
experiences, and relief for overextended parents, among other things. It's a
long list that justifies itself many times over. And, even if good early
childhood development platforms simply allow realization instead of revolution
of ability, that's another boon to add to the list. Realization of potential is
a worthy goal.
