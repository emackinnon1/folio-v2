...
presuppositions -- those of intelligence, social outcomes, and the malleability
of individual potential -- were exposed. Reexamination of assumptions is rarely
...
eventually you have to intervene on the system itself to make changes. There is
a difference between _realizing potential_ and _enhancing potential_.
...
current crawl. So, even with the weight of experimental data suggesting primacy
of the genome over the environment, many hold that poverty reduction is by far
the procedurally superior intervention: it's just simply more practical.
