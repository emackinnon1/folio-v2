...
I tend to have a hard time imagining a true platform for top-down control. In my view, us feeling like we have it is only a byproduct of our conscious "[user-illusion](https://en.wikipedia.org/wiki/User_illusion)",
which deposited a few evolutionary advantages. Every behavior I exhibit has its roots in physical causes and laws outside of my awareness, sweeping molecules and cells around the cluster of organized material.
...
to predict future states because of difficulties related to nonlinear systems, that doesn't mean that those bodies don't participate in causal chains with
...
that are in no way under their "control"?), justice systems, and human development.
...
in various fields, which have informed fuller pictures on the concepts. A few other different schools exist under determinism, including theological determinists, who view God
as the ultimate law of the universe by which our under and through which events happen, not physical law.

The other generally-encountered, competing positions are worth setting out:
...
account free will is true and determinism is therefore false. Choices are executed independent of prior causes and natural laws. This preserves moral responsibility, handing the
...
a tree falls, it does so because of the wind, the weak grip of the earth by its roots, or whatever the proximate cause(s) may be. When a person performs an act of free will, _they are the cause_ of
...
with their intentions, desires and rational deliberations. There is a subtle shift of definitions here which is worth noting.

Say you have the motivation that you'd like to stay healthy and avoid sweets. The compatibilist says, leaving prior causes to one side for now, since this is the desire,
we can define your will as simply that. Do you act and make choices in accordance or against it? A software program running on a processor in a robot might be considered to have "will"
and "motivation" in this sense, as such displaying free will when acting in accordance with its programming. Criticisms of this school of thought tend to center on the redefinition
of "free will"; determinists and libertarians alike think it side steps the actual question ("Could one choose otherwise?"), but the practicality follows much of how
society functions: We have retreated, when we deem appropriate, behind a line of deterministic absolution of guilt for crimes committed when it is judged that someone
could not choose another avenue due to biological disease (i.e. committing a crime while in the middle of a bipolar episode, or at the onset of [Huntington's](https://en.wikipedia.org/wiki/Vince_Gilmer)). It
acknowledges causality while maintaining accountability. The trouble is where the line actually exists: those brain cells, mechanically, work the exact same when we
have schizophrenia versus when we don't, it's just that schizophrenia has a different set of outcomes.
...
So, should free will even matter to me if I have this invisible straightjacket, my user illusion, on? What's the point of invoking it if I don't stay consistent, especially when
...
that Sapolsky has earned, my struggles. In it, Sapolsky endeavors to talk about this topic from a scientific perspective, an approach that I find grounding when topics
become airy and abstract: what is even _possible_ in the physical world, and should we reform our concepts based on that? Sam Harris, Daniel Dennett, Thomas Hobbes,
David Hume, Augustine, Aquinas, Epicurus, Aristotle and many, many, many others have made a meal of it philosophically, but I have been interested in how views might nestle into the physical sciences.
The book itself is obviously worth the read (his previous book, _Behave_, even moreso), but a [summary of the book](https://www.psychiatrypodcast.com/psychiatry-psychotherapy-podcast/a-summary-of-determined-by-robert-sapolsky-does-free-will-existalexander-horwitz-md)
...
we are not even free to make our own decisions. We are not captains of our ship, our ship never even had a helm. We are automatons, but stuck with an illusion of agency
and sensations that make us think our will is applied to the universe instead of the universe applying to us.
