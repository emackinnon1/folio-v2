...
Freedom sounds like a no-brainer at first blush. Of course we should be free to
do what we want with our lives. But that runs into friction quickly: my freedom
to blast music at 2 a.m. conflicts with your freedom to sleep. In a completely
unregulated market, someone could exploit others, manipulate systems, or build
monopolies—and no one could stop them.
...
Karl Popper's
[famous insight](https://en.wikipedia.org/wiki/Paradox_of_tolerance): a society
that tolerates intolerance will, over time, lose its ability to remain tolerant.
Because the intolerant, by nature, do not reciprocate. Tolerance, ironically,
requires certain boundaries to survive.
...
Limits in this landscape are easy to see as prudent. Absolutism on this topic is
cutting off your nose to spite your face, in the long run.
...
expression. The right to offend has become a shield for, honestly abhorrent and
...
opposition: those of inclusion and social equality.
...
- Calls for progressive (as in, progressive from the status quo) education are
...
> the law protects but does not bind, and out-groups whom the law binds but does
> not protect.
