...
opposition: those of inclusion and social equality. The oh-so-welcoming left
likes the moral high ground, except if that ground happens to be their own zip
code.
...
christian/sharia law, NIMBY-ism and the madness of crowds.
