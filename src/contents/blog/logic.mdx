...
It is the case that the Declaration of Independence was signed and it always will have the same truth value.

Take note that this condition of truth to an assertion about the signing of the Declaration of Independence signed is not due to the merits of our epistemic condition.
In other words, we might imagine that we did not, in fact, know that the document was signed; nonetheless, we may find it perfectly logical to say that the assertion
has a truth value independent of our personal knowledge. The truth or falsity depends on what happened before.
...
This dichotomy is in fact a necessary truth, according to Aristotle, not the sea battle's occurance, because the logical operator denotes that one or the other is true.
It is necessary that it will _occur or not_, an easy enough step back into a truth function of the consitutient disjuncts, but a muddying of the law of the excluded
middle.
